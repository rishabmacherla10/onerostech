...
def game_page():
	desc_list=["word","craps","roulette","sicbo","baccarat","desc6","desc7","desc8","desc9","desc10","desc11"]
	...
	game_names=["Word Cross Search","Craps Live casino","Roulette Live Casino","Sic Bo Multiplayer Casino","Baccarat Live","Caribbean Stud Poker","Crazy 4 Poker Casino","Let it Ride Casino","Pai Gow Poker","Three Card Poker","Mississippi Stud Poker"]
	...
	if request.method == "POST":
		...
		if btn_name == "word" :
			...
			return render_template('game_page.html',icon=game_icon,desc=desc_con,image=game_image,video=game_video,ss=screens,folder=fname,name=game_name)
		elif btn_name == "craps" :
			screens=[]
			...
			for i in range(0,6):
				screens.append(screenshots[i])
			return render_template('game_page.html',desc=desc_con,icon=game_icon,image=game_image,video=game_video,ss=screens,folder=fname,name=game_name)
